...
CREATE TABLE ST_GROUP      (GroupNumber INTEGER PRIMARY KEY,      Specialization VARCHAR(100) NOT NULL);
...
CREATE TABLE STUDENT  (StudentId INTEGER PRIMARY KEY,    StudentName VARCHAR(100) NOT NULL,   GroupNumber INTEGER,   BirthDate DATE,   Address VARCHAR(100));

ALTER TABLE STUDENT ADD CONSTRAINT GROUP_ST_FK FOREIGN KEY(GroupNumber) REFERENCES ST_GROUP(GroupNumber);

INSERT INTO STUDENT(StudentId, StudentName, GroupNumber,BirthDate, Address) VALUES(345567,'Иванов Александр', 341, TO_DATE('1999-01-20','YYYY-MM-DD'), 'Петергоф, Библиотечная пл., дом 2');
INSERT INTO STUDENT(StudentId, StudentName, GroupNumber,BirthDate, Address) VALUES(345568,'Широков Федор', 341, TO_DATE('1998-03-21', 'YYYY-MM-DD'), 'Санкт-Петербург, ул. Гаванская 34');
INSERT INTO STUDENT(StudentId, StudentName, GroupNumber,BirthDate, Address) VALUES(345569,'Антонова Даша', 341, TO_DATE('1999-05-17','YYYY-MM-DD'), 'Санкт-Петербург, ул. Широкая 45');
INSERT INTO STUDENT(StudentId, StudentName, GroupNumber,BirthDate, Address) VALUES(345570,'Антипенко Денис', 371, TO_DATE('1998-08-11', 'YYYY-MM-DD'), 'Санкт-Петербург, Малый пр. 15');
INSERT INTO STUDENT(StudentId, StudentName, GroupNumber,BirthDate, Address) VALUES(345571,'Сидоров Александр', 371, TO_DATE('1999-07-12','YYYY-MM-DD'), 'Санкт-Петербург, Средний пр. 4');
INSERT INTO STUDENT(StudentId, StudentName, GroupNumber,BirthDate, Address) VALUES(345572,'Фадеев Дмитрий', 371, TO_DATE('1999-11-24', 'YYYY-MM-DD'), 'Санкт-Петербург, Невский пр.23');

CREATE TABLE PHONE_LIST  (StudentId INTEGER NOT NULL, PhoneType CHAR(10),  Phone CHAR(30) NOT NULL);
...
INSERT INTO EXAM_SHEET    (ExamSheetId,GroupNumber,CourseId,TeacherId,ClassRoom,ExamDate) VALUES(1,341,1,1,2408,TO_DATE('2017-01-25','YYYY-MM-DD'));
INSERT INTO EXAM_SHEET    (ExamSheetId,GroupNumber,CourseId,TeacherId,ClassRoom,ExamDate) VALUES(2,371,1,1,2408,TO_DATE('2017-01-27', 'YYYY-MM-DD'));
INSERT INTO EXAM_SHEET    (ExamSheetId,GroupNumber,CourseId,TeacherId,ClassRoom,ExamDate) VALUES(3,341,2,2,2446,TO_DATE('2017-01-28', 'YYYY-MM-DD'));
INSERT INTO EXAM_SHEET    (ExamSheetId,GroupNumber,CourseId,TeacherId,ExamDate)           VALUES(4,371,2,2,TO_DATE('2017-01-26', 'YYYY-MM-DD'));
